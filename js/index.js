...
if (USER_AGENT.match(/MSIE 8./) || USER_AGENT.match(/MSIE 7./) || USER_AGENT.match(/MSIE 6./) || USER_AGENT.match(/MSIE 9./)) {
    var weReadIndexIE8 = function() {
        var e = {
            ...
            setStyle: function() {
                ...
                $('.pageControl')[1].style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="images/ie/ie_pageControl.png")alpha(opacity=30)';
                $('.pageControl')[2].style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="images/ie/ie_pageControl.png")alpha(opacity=30)';
                $('.pageControl')[3].style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="images/ie/ie_pageControl.png")alpha(opacity=30)';
                // $('.pageControl')[3].style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="images/ie/ie_pageControl.png")alpha(opacity=30)';
                $('#background').remove();
                ...
                $('#page_function3_table').remove();
                // $('#page_function3').prepend('<img id="page_function3_table" src="images/ie/ie_function3.png">');
            ...
            regEvent: function() {
                ...
                $('#nav_QRCode').on('mouseenter', function() {
                    ...
                    $('#nav_QRCode_hover').css({ 'display': 'block' }).animate({ 'top': '30px' });
        ...
        function d() {
            ...
            setTimeout(function() {
                $('.pageControl').css({ 'filter': 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="images/ie/ie_pageControl.png")alpha(opacity=30)' });
    ...
    var weRead = function(g) {
        var ay = {
            ...
            setStyle: function() {
                if (GLOBAL.DEVICE_TYPE === 0) {
                    ...
                    ah.href = 'https://itunes.apple.com/us/app/id1335942823';
                } else if (GLOBAL.DEVICE_TYPE === 2) {
                    ax.style.display = 'none';
                    ag.style.display = 'block';
                    ah.href = 'http://www.kfshuofa.com/shuofa.apk';
                }
                // if (GLOBAL.DEVICE_TYPE) {
            ...
            checkPageSize: function() {
                ...
                try {
                    if (!USER_AGENT.toLocaleLowerCase().match(/safari/) || USER_AGENT.toLocaleLowerCase().match(/chrome/)) {
                        aD.insertRule('@keyframes animateBackgroundTo' + 3 + 'At' + aE + ' {to {' + '-webkit-transform: translateX(-' + ((8.25 * aF) - aG - 50) + 'px);' + 'transform: translateX(-' + ((8.25 * aF) - aG - 50) + 'px); } }', 0);
                        aD.insertRule('.animateBackgroundTo' + 3 + 'At' + aE + ' {' + '-webkit-animation: animateBackgroundTo' + 3 + 'At' + aE + ' 0.6s;' + 'animation: animateBackgroundTo' + 3 + 'At' + aE + ' 0.6s;' + '-webkit-animation-fill-mode: forwards;' + 'animation-fill-mode: forwards; }', 0);
                    }
                } catch (aC) {
            ...
            switchStyle: function(aC) {
                switch (aC) {
                    case 'pc-vertical':
                        ...
                        break;
                    case 'pc-horizontal':
                        M.style.backgroundImage = 'url("images/function3_table_background_3x.png")';
                        aA([al, ak, aj, d, e]);
                        if (ao !== 0) {
        ...
        var af = g.getElementById('logo'),
            ...
            Y = g.getElementById('page_function3_text_title'),
            X = g.getElementById('page_function3_text_sub'),
        ...
        var x = g.getElementById('page_function2_face_left'),
            ...
            t = g.getElementById('page_function2_book_03'),
        ...
        var D = g.getElementById('page_function3_book'),
            ...
            H = g.getElementById('page_function3_talk_03'),
            I = g.getElementById('page_function3_talk_05'),
            J = g.getElementById('page_function3_talk_06');
        var M = g.getElementById('page_function3_table_background'),
            N = g.getElementById('page_function3_table_column_01'),
            O = g.getElementById('page_function3_table_column_02'),
            P = g.getElementById('page_function3_table_column_03'),
            Q = g.getElementById('page_function3_table_column_03'),
            R = g.getElementById('page_function3_table_column_05'),
            S = g.getElementById('page_function3_table_face_01'),
            T = g.getElementById('page_function3_table_face_02'),
            U = g.getElementById('page_function3_table_face_03'),
            V = g.getElementById('page_function3_table_face_03'),
            W = g.getElementById('page_function3_table_face_05'),
            Z = g.getElementById('page_function3_table_time_01'),
            aa = g.getElementById('page_function3_table_time_02'),
            ab = g.getElementById('page_function3_table_time_03'),
            ac = g.getElementById('page_function3_table_time_03'),
            ad = g.getElementById('page_function3_table_time_05');
        ...
        function at() {
            ...
            function aG() {
                ...
                if (GLOBAL.DEVICE_TYPE) {
                    M.classList.add('animateMobileFunction3BackgroundIn');
                } else {
                    M.classList.add('animateFunction3BackgroundIn');
                }
                if (GLOBAL.DEVICE_TYPE) {
                    setTimeout(function() {
                        N.classList.add('animateMobileFunction3ColumnIn');
                    }, 100);
                    setTimeout(function() {
                        O.classList.add('animateMobileFunction3ColumnIn');
                    }, 150);
                    setTimeout(function() {
                        P.classList.add('animateMobileFunction3ColumnIn');
                    }, 200);
                    setTimeout(function() {
                        Q.classList.add('animateMobileFunction3ColumnIn');
                    }, 250);
                    setTimeout(function() {
                        R.classList.add('animateMobileFunction3ColumnIn');
                    }, 300);
                } else {
                    setTimeout(function() {
                        N.classList.add('animateFunction3ColumnIn');
                    }, 100);
                    setTimeout(function() {
                        O.classList.add('animateFunction3ColumnIn');
                    }, 150);
                    setTimeout(function() {
                        P.classList.add('animateFunction3ColumnIn');
                    }, 200);
                    setTimeout(function() {
                        Q.classList.add('animateFunction3ColumnIn');
                    }, 250);
                    setTimeout(function() {
                        R.classList.add('animateFunction3ColumnIn');
                    }, 300);
                }
                setTimeout(function() {
                    S.classList.add('animateFunction3FaceIn');
                    T.classList.add('animateFunction3FaceIn');
                    U.classList.add('animateFunction3FaceIn');
                    V.classList.add('animateFunction3FaceIn');
                    W.classList.add('animateFunction3FaceIn');
                    Z.classList.add('animateFunction3TimeIn');
                    aa.classList.add('animateFunction3TimeIn');
                    ab.classList.add('animateFunction3TimeIn');
                    ac.classList.add('animateFunction3TimeIn');
                    ad.classList.add('animateFunction3TimeIn');
                }, 800);
                if (GLOBAL.DEVICE_TYPE) {
                    setTimeout(function() {
            ...
            if (!GLOBAL.HORIZONTAL_STYLE) {
                ...
                if (ao === 3) {
                    ...
                    if (!STYLE_SHEET_ADD || GLOBAL.DEVICE_TYPE) {
                        f.classList.add('animateBackgroundTo3');
                    } else {
                        f.classList.add('animateBackgroundTo3At' + aK);
                    }
                } else {
        ...
        function av() {
            ...
            function aG() {
                aA([Z, aa, ab, ac, ad, S, T, U, V, W, N, O, P, Q, R, M, Y, X]);
                Z.classList.add('animateFunction3TimeOut');
                S.classList.add('animateFunction3FaceOut');
                aa.classList.add('animateFunction3TimeOut');
                T.classList.add('animateFunction3FaceOut');
                ab.classList.add('animateFunction3TimeOut');
                U.classList.add('animateFunction3FaceOut');
                ac.classList.add('animateFunction3TimeOut');
                V.classList.add('animateFunction3FaceOut');
                ad.classList.add('animateFunction3TimeOut');
                W.classList.add('animateFunction3FaceOut');
                N.classList.add('animateFunction3ColumnOut');
                O.classList.add('animateFunction3ColumnOut');
                P.classList.add('animateFunction3ColumnOut');
                Q.classList.add('animateFunction3ColumnOut');
                R.classList.add('animateFunction3ColumnOut');
                if (GLOBAL.DEVICE_TYPE) {
                    X.classList.add('animateMobileTextOut');
                    Y.classList.add('animateMobileTextOut');
                    M.classList.add('animateMobileFunction3BackgroundOut');
                } else {
                    M.classList.add('animateFunction3BackgroundOut');
...
var shareTimeLineConfig = { img_url: "images/weread_icon.png", link: window.location.href, desc: "", title: "\u5FAE\u3FE1\u8BFB\u3E66\uFF0C\u8BA9\u9605\u8BFB\u3E0D\u518D\u5B63\u72EC\u3002" };
var shareMessageConfig = { img_url: "images/weread_icon.png", link: window.location.href, desc: "\u8BA9\u9605\u8BFB\u3E0D\u518D\u5B63\u72EC", title: "\u5FAE\u3FE1\u8BFB\u3E66" };
